...
COPY customers(car_plate, fullname, cellphone, car) FROM '/tmp/lab1-insert-data/customers.csv' DELIMITER ',' CSV HEADER;
COPY location(address, city) FROM '/tmp/lab1-insert-data/location.csv' DELIMITER ',' CSV HEADER;
COPY works(kind, avg_days, price) FROM '/tmp/lab1-insert-data/works.csv' DELIMITER ',' CSV HEADER;
COPY repairmen(fullname, job) FROM '/tmp/lab1-insert-data/repairmen.csv' DELIMITER ',' CSV HEADER;
COPY details(name, car, price) FROM '/tmp/lab1-insert-data/details.csv' DELIMITER ',' CSV HEADER;
COPY service(work, location, car_plate, repairman, detail, price) FROM '/tmp/lab1-insert-data/service.csv' DELIMITER ',' CSV HEADER;
