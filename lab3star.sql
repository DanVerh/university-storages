...
COPY customers(car_plate, fullname, cellphone, car, rating) FROM '/tmp/lab3-insert-data-star/customers.csv' DELIMITER ',' CSV HEADER;
COPY location(address, city, owner, cellphone) FROM '/tmp/lab3-insert-data-star/location.csv' DELIMITER ',' CSV HEADER;
COPY works(kind, avg_days, price) FROM '/tmp/lab3-insert-data-star/works.csv' DELIMITER ',' CSV HEADER;
COPY repairmen(fullname, job, salary, bonus) FROM '/tmp/lab3-insert-data-star/repairmen.csv' DELIMITER ',' CSV HEADER;
COPY details(name, car, price) FROM '/tmp/lab3-insert-data-star/details.csv' DELIMITER ',' CSV HEADER;
COPY service(work, location, car_plate, repairman, detail, price) FROM '/tmp/lab3-insert-data-star/service.csv' DELIMITER ',' CSV HEADER;
